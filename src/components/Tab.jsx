  ...
  return (
    <div className='flex flex-row'>
      <div className='flex flex-col justify-between rounded-lg bg-[#cccccc] dark:border-gray-700 sticky top-0 h-screen flex'>
        ...
        <button className='bg-[#7d3cff] sticky top-0 inline-flex justify-between items-center justify-center p-4 mb-[10px] ml-[10px] text-white rounded-lg group text-[24px] w-[200px] h-[80px]'>
          {profile.pic ? (
            <img
              alt='icon'
              src={profile.pic}
